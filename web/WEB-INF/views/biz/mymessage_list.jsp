...
<section class="banner">
    <div class="container">
        <div>
            <h1>杨春晓留言板</h1>
            <p>
                杨春晓是垂直的互联网IT技能免费学习网站。以独家视频教程、在线编程工具、学习计划、问答社区为核心特色。在这里，你可以找到最好的互联网技术牛人，也可以通过免费的在线公开视频课程学习国内领先的互联网IT技术。 </p>
        </div>
    </div>
</section>
<section class="main">
        ...
        <c:forEach items="${messages}" var="msg">
            <div class="alt-item">
                ...
                <div class="alt-content">
                    ...
                    <p>${msg.content}</p>
                    <p>
                    <form action="${basePath}/edit/message.do" method="post">
                        <input type="hidden" name="id" value="${msg.id}">
                        <input type="submit" value="编辑">
                    </form>
                    <a href="javascript:void(0);" id="${msg.id}" class="delete">删除</a>
...
<section class="page">
    <div class="container">
        <% if (null != request.getSession().getAttribute("user")) {%>
        <div id="fatie">
            <a href="${pageScope.basePath}/addMessagePrompt.do">
                <button>点我留言</button>
            </a>
        </div>
        <%} else { %>
        <div id="fatie">
            请<a href="${pageScope.basePath}/login.do">
            <button>登录</button>
        </a>后留言
        </div>
        <% } %>
        ...
        <div id="pagefy">
            <ul>
                <form id="messageForm" action="${pageScope.basePath}/my/message/list.do" method="post">
                    ...
                    <li><a href="javascript:void(0)">当前第${page}页 共${last}页</a></li>
...
<script>
    $('.delete').click(function () {
        var id = $(this).attr("id");
        var th = $(this);
        $.post("${basePath}/del/message.do", {id: id}, function (data) {
            if (data == 1) {
