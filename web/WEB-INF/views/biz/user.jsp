...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="${pageScope.basePath}/editUserPrompt.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="realName" value="${user.getRealname()}" readonly>
                    </div>
                </div>
                <div class="form-group">
